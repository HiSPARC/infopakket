...
Het Download data formulier, zie \figref{fig:get_data}, staat men toe
...
verschijnen dan naast elkaar, zie \figref{fig:plot_options}. Nu kan uit
...
\begin{figure}
    \centering
    \includegraphics[scale=0.4]{plot_options}
