...
\newcommand{\docinstallatie}[2]{\setdocumentstyle{Gold}{Installatie}{#1}{#2}}
...
\newcommand{\docwerkblad}[2]{\setdocumentstyle{ForestGreen}{Werkblad}{#1}{#2}}
\newcommand{\docdocent}[2]{\setdocumentstyle{DarkKhaki}{Docent}{#1}{#2}}
