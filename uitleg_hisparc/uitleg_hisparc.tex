...
Webadres: \url{http://www.hisparc.nl/docent-student/lesmateriaal/informatie-pakket/}.
...
van de richting  en energie van gedetecteerde showers. De data die het
\hisparc netwerk kan via de volgende website opgevraagd worden,
\url{http://data.hisparc.nl/media/jsparc/data_retrieval.html}, hoe de
data retrieval werkt en hoe je er snelle analyses mee kunt doen en
...
Uit de pulsen die gemeten worden door de meetstations als de deeltjes, die geproduceerd 
worden in een kosmische shower, invallen op de detectoren wordt informatie gehaald 
die leidt tot de kolommen: Arrival time, Pulseheight, Pulseintegral, Number of MIP's.
...
lesmateriaal/informatie-pakket/}
...
dus een twee detector station). De maximale waarde van de pulsen is daar
...
event is. Met behulp van het aantal deeltjes per detector kunnen we de
energie van het primaire deeltje wat de shower veroorzaakt
reconstrueren. Omdat we weten hoe de shower zich ontwikkelt in de
...
lastig en vereist een gedegen kennis van het wiskundige ontwikkeling van
