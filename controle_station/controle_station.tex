...
\figref{fig:frontweb} een screenshot te zien is. Op de site staan alle
...
\begin{figure}
    \centering \includegraphics[scale=0.40]{websitefront}
...
\underline{501-Nikhef}) zoals te zien is in \figref{fig:frontweb}. Dan
...
van een station is weergeven in \figref{fig:websiteerror}. In
\figref{fig:websiteerror} is te zien dat het station niet meer meet na
...
status en problemen overzicht, zie \figref{fig:statusstation}. In
\figref{fig:statusstation} is te zien dat de \emph{TriggerRate} rood is
...
\url{https://docs.hisparc.nl/maintenance/}, zie \figref{fig:maintenance}.
...
\figref{fig:solution}. Voor de foutmelding \emph{TriggerRate} vinden we
...
\url{hisparc@utah.edu}.


\begin{figure}
\centering
\includegraphics[scale=0.40]{statusstation}
...
\begin{figure}
\centering
\includegraphics[scale=0.40]{maintenance}
