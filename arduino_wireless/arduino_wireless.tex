...
Ook komt het wel eens voor dat de string data leeg is. Dat wil je ook voorkomen.
...
if nieuwe_data != ' ' and nieuwe_data !=vorige_data and len(data)>32:
    file = open(".\Documents\Arduino\Metingen\Metingen.txt", "a")
...
bijvoorbeeld 3x een temperatuurmeting, luchtdruk en luchtvochtigheid.
