...
rechts,  zie \figref{fig:DS18B20}. Bij uw sensor kan dit anders zijn.
...
ge\:{i}installeerd en getest, dan kunnen de temperatuursensoren
...
\begin{figure}
    \centering
    \subfloat[]{
        \includegraphics[width=.3\linewidth]{DS18B20}
        \label{fig:DS18B20}}
    \hfill
    \subfloat[]{
...
Zoals in \figref{fig:BMP085} te zien is heeft de luchtdruksensor 6
...
\begin{figure}
    \centering
    \subfloat[]{
        \includegraphics[width=.3\linewidth]{BMP085}
        \label{fig:BMP085}}
    \hfill
    \subfloat[]{
...
gebruik. De rechter pin is de ground. Zie \figref{fig:DHT22}. We hebben
...
\begin{figure}
    \centering
    \subfloat[]{
        \includegraphics[width=.3\linewidth]{DHT22}
        \label{fig:DHT22}}
    \hfill
    \subfloat[]{
...
Nu we alle sensoren afzonderlijk hebben getest,kunnen we de sensoren gaan combineren en ook het programma schrijven wat alle 
...
In \figref{fig:Arduino_weerstation_schakeling} zie we alle sensoren (op
