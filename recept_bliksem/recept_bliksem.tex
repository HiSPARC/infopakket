...
Zoals te zien is in \figref{fig:overview_website} en \figref{fig:data_download}
en \figref{fig:KNMI_data}, is het relatief eenvoudig om dagen te vinden met 
bliksemdata.
\section{Les 3}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.4]{KNMI_data}
