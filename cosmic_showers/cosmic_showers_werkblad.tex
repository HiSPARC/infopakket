...
Als een muon een snelheid heeft dat 99,9\% is van de lichtsnelheid, dan is zijn energie $2,36$ GeV. Druk de energie van \SI{2,36}{\giga\electronvolt} uit in joule ($\SI{}{\joule}$).
\begin{center}
    \rule{\textwidth}{0.3mm}\\
    \rule{\textwidth}{0.3mm}\\
\end{center}
...
\begin{minipage}[t]{1\columnwidth}\paragraph{Opdracht 8:}
