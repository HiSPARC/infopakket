...
\label{fig:heitler}
\end{figure}
In werkelijkheid wordt bij een splitsing de energie niet gelijk verdeeld. Ook duurt het bij het ene deeltje langer voor het splitst dan bij het andere deeltje; dat hangt van het toeval af. Het belangrijkste gevolg is dat de shower niet plotseling stopt, maar geleidelijk afneemt (\figref{fig:greisen}).
\begin{figure}
\centering
...
\bibitem{strang}, Photo taken by U.S. Air Force Senior Airman J. Strang.
