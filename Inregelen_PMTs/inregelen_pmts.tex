...
\thispagestyle{fancy}
\begin{tikzpicture}[remember picture,overlay,font=\sffamily]
  \node[fill,text=white,anchor=north
  east,xshift=-1cm,yshift=-1cm,align=center,minimum width=\paperwidth-1cm,
  minimum height=1.5em] at (current page.north east)
  {Theorie --- Inregelen \pmts};
\end{tikzpicture}
