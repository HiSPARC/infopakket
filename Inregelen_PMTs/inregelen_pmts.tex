...
in signalen uit de \hisparc detectoren (\figref{fig:spectrum_componenten}).
...
De standaard triggervoorwaardes voor een twee-plaats opstelling is
...
twee detectoren met een piekwaarde boven de \SI{70}{\milli\volt} óf
...
histogram naar rechts is verschoven.  We proberen om de bult van
\SI{1}{\mip} bij een spanning van ongeveer \SI{200}{\milli\volt} te
leggen.  In de linker plot is de spanning te laag, in de rechter plot te
hoog.  De middelste plot laat het goede beeld zien.
...
\item Verhoog de spanning nu zodanig dat de singles voor de \emph{low
threshold} uitkomen op ongeveer 250, en voor de \emph{high threshold} op
ongeveer 120.
\item Laat de detector een tijdje meten en controleer dat de \SI{1}{\mip}
bult uitkomt bij ongeveer \SI{200}{\milli\volt}.
\end{enumerate}
