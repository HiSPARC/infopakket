...
\begin{tikzpicture}[remember picture,overlay,font=\sffamily]
  \pgfmathsetmacro{\seccolorstep}{100-(\thepage-1)*15};
  \colorlet{seccolor}{red!\seccolorstep!yellow}
  \colorlet{seccolor}{red}

  \node[seccolor,fill,text=white,anchor=north
  west,xshift=2cm,yshift=-1cm, minimum height=3em,
  %align=left, text width=8cm
  ] at (current page.north west) {\Huge
  Theorie};

  \node[seccolor,fill,text=white,anchor=north
  east,xshift=-1cm,yshift=-1cm, minimum height=3em] at (current page.north
  east) {\Huge \thetitle};

  \node[anchor=north
  east,xshift=-1cm,yshift=-2cm, minimum height=2em] at (current page.north
  east) {\theauthor};

  \draw[seccolor] ($(current page.north east) + (-1cm, 0)$) -- +(0, -\paperheight);
 
  \fill[seccolor] ($(current page.north east) + (0, -2cm-\thepage*1cm)$)
  rectangle +(-1cm, +.5cm);
\end{tikzpicture}
}
\fancyhead{\thumb}
\fancyfoot[C]{\shorttitle\ -- \thepage}
...
\title{Dagelijkse controle van het station}
...
%\begin{titlepage}
%\begin{tikzpicture}[remember picture,overlay,font=\sffamily]
%  \node[red,fill,text=white,anchor=north
%  west,xshift=1cm,yshift=-1cm, minimum height=2em] at (current page.north
%  west) {\Huge Theorie};
%
%  \node[red,fill,text=black,anchor=north
%  east,xshift=-1cm,yshift=-1cm, minimum height=2em] at (current page.north
%  east) {\Huge \thetitle};
%
%  \node[anchor=north
%  east,xshift=-1cm,yshift=-2cm, minimum height=2em] at (current page.north
%  east) {\theauthor};
%
%  \fill[red] ($(current page.north east) + (0, -2cm-\thepage*1cm)$)
%  rectangle +(-1cm, +.5cm);
%\end{tikzpicture}
%\end{titlepage}
