...
\begin{tikzpicture}[remember picture,overlay,font=\sffamily]
  \draw ($(current page.north east) + (-1cm, 0)$) -- +(0, -\paperheight);
  
  \fill ($(current page.north east) + (0, -2cm-\thepage*1cm)$)
  rectangle +(-1cm, +.5cm);
\end{tikzpicture}
}
\fancyhead{\thumb}
...
\begin{titlepage}
\begin{tikzpicture}[remember picture,overlay,font=\sffamily]
  \node[red!40,fill,text=white,anchor=north
  west,xshift=1cm,yshift=-1cm, minimum height=2em] at (current page.north
  west) {Theorie};

  \node[green!40,fill,text=white,anchor=north
