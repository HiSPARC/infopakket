...
Voordat notebooks kunnen worden gebruikt, installeren we \python 2.7. Als we een \python distributie installeren
dan worden alle hulppakketen e.d. direct meegeinstalleerd. Anaconda is een zeer complete distributie die voor
wetenschappelijke \python toepassingen het meest gebruikt wordt.

Download Anaconda: (\url{https://www.continuum.io/downloads})
\end{itemize}

Kies de \python 2.7 versie van Anaconda.

De procedure voor de installatie van Anaconda op een Windows computer is alsvolgt:
\begin{itemize}
