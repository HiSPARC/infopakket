...
\begin{figure}[ht]
    ...
    \caption{De HiSPARC master unit, foto uit \cite{nikhefhisparc}. In de
             ...
             lichten op als er straling door respectievelijk detector 1
             of detector 2 wordt gemeten. In de praktijk worden de
             detectoren ongeveer iedere \SI{10}{\milli\second} geraakt.
             Achter de koelgaten is een witte led te zien. Deze licht op
             als beide detectoren binnen een tijdsinterval van
             \SI{1.5}{\micro\second} straling waarnemen, dit komt veel
             minder vaak voor.}
\end{figure}
...
\begin{tabular}{|x{.11\textwidth}|x{.11\textwidth}|x{.11\textwidth}
                ...
                |x{.11\textwidth}|}
    \cline{2-7} 
    \multicolumn{1}{c|}{} & 1 & 2 & 3 & 4 & 5 & $N_{gem.}$\\
    \hline 
    $N$ &  &  &  &  &  & \tabularnewline
    \hline 
\end{tabular}%
...
\begin{tabular}{|x{.11\textwidth}|x{.11\textwidth}|x{.11\textwidth}
                ...
                |x{.11\textwidth}|}
    \cline{2-7} 
    \multicolumn{1}{c|}{} & 1 & 2 & 3 & 4 & 5 & $\left(N^{2}\right)_{gem}$\\
    \hline 
    $N^{2}$ &  &  &  &  &  & \\
    \hline 
\end{tabular}
...
getriggerd. Let op dat je niet iedere keer schudt tot er ,,toevallig''
...
één detector kan per keer maximaal een tiental deeltjes meten, daarna
meet het station niets extra's meer.
...
\begin{itemize}
    ...
    \item Begin overnieuw bij station a met de kortere lijst en herhaal
...
\begin{thebibliography}{9}
    \bibitem{nikhefhisparc} Nikhef, \emph{\hisparc Electronica},\\
